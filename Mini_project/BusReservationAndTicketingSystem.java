...
public class BusReservationAndTicketingSystem {
	...
	public static void main(String args[]) throws IOException {
		...
		for (int i = 1; i < 4;) {
			...
			if (user.equals("Razzaq")) 
				System.out.println("Valid Username");
			else {
				System.out.println("InValid Username");
			}	
			if(password.equals("Razzaq@2003"))
			 {
				...
				for (int x = 1; x == 1;) {
					...
					for (x = 1; x == 1;) {
						...
						if (choice.equals("1")) {
							...
							System.out.println("***************************************");
							System.out.println("** 1.)MUMBAI CITY   | Pp600 |   " + available[1] + "   **");
							System.out.println("** 2.)PUNE CITY     | Pp170 |   " + available[2] + "   **");
							System.out.println("** 3.)KOLHAPUR      | Pp150 |   " + available[3] + "   **");
							System.out.println("** 4.)NAGPUR        | Pp200 |   " + available[4] + "   **");
							System.out.println("** 5.)RATNAGIRI     | Pp250 |   " + available[5] + "   **");
							System.out.println("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
							System.out.println("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n");
						...
						// if CHOICE is "2" proceed to Ticket Booking//
							...
							// inputing of Passenger's Name//
								...
								String dest[] = { " ", "MUMBAI CITY", "PUNE CITY", "KOLHAPUR ", "NAGPUR", "RATNAGIRI" };
							...
							for (x = 1; x == 1;) {
								...
								for (int b = 0; b < z; b++) {
									if (search.equalsIgnoreCase(ticketS[b][0])) {
										...
										System.out.println("FARE PRICE: Pp" + ticketD[b][0]);
										...
										if (ticketS[b][2].equals("x")) {
											...
											for (x = 1; x == 1;) {
												System.out.println("\nPASSENGER'S TOTAL FARE: Pp " + ticketD[b][2]);
												...
												if (change[b] < 0) {
													...
													System.out.println("CHANGE: Pp " + change[b]);
													System.out.println("");
													x = 0;
												}
											}
